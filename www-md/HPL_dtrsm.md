<!-- Converted from HPL_dtrsm HPL 2.3 Library Functions December 2, 2018 -->
...
<PRE>
SIDE    (local input / 本地输入)                 const enum HPL_SIDE
...
<PRE>
UPLO    (local input / 本地输入)                 const enum HPL_UPLO
...
<PRE>
DIAG    (local input / 本地输入)                 const enum HPL_DIAG
...
<PRE>
B       (local input/output / 本地输入/输出)          double *
...
<H1>See Also / 另见</H1>
<A HREF="HPL_dgemm.md">HPL_dgemm</A>.
