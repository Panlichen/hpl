<!-- Converted from HPL_dgemm HPL 2.3 Library Functions December 2, 2018 -->
...
<PRE>
TRANSA  (local input / 本地输入)                 const enum HPL_TRANS
...
<PRE>
TRANSB  (local input / 本地输入)                 const enum HPL_TRANS
...
<PRE>
B       (local input / 本地输入)                 const double *
...
<PRE>
C       (local input/output / 本地输入/输出)          double *
...
<PRE>
LDC     (local input / 本地输入)                 const int
...
<H1>See Also / 另见</H1>
<A HREF="HPL_dtrsm.md">HPL_dtrsm</A>.
