<!-- Converted from HPL_spreadT HPL 2.3 Library Functions December 2, 2018 -->
...
<PRE>
SIDE    (global input / 全局输入)                const enum HPL_SIDE
...
<PRE>
SRCDIST (local input / 本地输入)                 const int
        On entry,  SRCDIST  specifies the source process that spreads
        its piece of U.
</PRE>
<PRE>
IPLEN   (global input / 全局输入)                const int *
...
<PRE>
IPMAP   (global input / 全局输入)                const int *
...
<PRE>
IPMAPM1 (global input / 全局输入)                const int *
